...
npm run test:scenarios    # drives docker compose itself: recreates the prerender container per suite
npm run test:coverage     # in-process coverage (url-normalize.js only - see below)
